...
button.addEventListener("click", () => {
  ...
  if (height_status && weight_status) {
    ...
    if (bmi < 18.6) {
      result.innerHTML =
        "anda kekurangan berat badann, cara mengatasi nya dengan Tingkatkan menu makanan harian dengan makanan yang tinggi kandungan nutrisinya seperti sayur, buah, gandum utuh, kacang-kacangan, biji-bijian, atau ikan laut. : " + bmi;
